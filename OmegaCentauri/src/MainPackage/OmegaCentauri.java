...
//        allyShips.add(new Fighter(2400, 3800, MainPackage.Type.Fighter, 8, 4, 4, .15, 150, 100, this));
        enemyShips.add(new EnemyFighter(3500, 5000, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 1, this));
        //enemies
...
//        // below
//        enemyShips.add(new EnemyFighter(6800, 5300, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 1, this));
//        enemyShips.add(new EnemyFighter(6800, 5600, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 2, this));
//        enemyShips.add(new EnemyFighter(6800, 5900, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 3, this));
//        enemyShips.add(new EnemyFighter(6800, 6200, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 4, this));
//         // above
//        enemyShips.add(new EnemyFighter(6800, 4700, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 5, this));
//        enemyShips.add(new EnemyFighter(6800, 4400, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 6, this));
//        enemyShips.add(new EnemyFighter(6800, 4100, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 7, this));
//        enemyShips.add(new EnemyFighter(6800, 3800, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 8, this));
//        // behind
//        enemyShips.add(new EnemyFighter(7600, 5300, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 9, this));
//        enemyShips.add(new EnemyFighter(7600, 5600, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 10, this));
//        enemyShips.add(new EnemyFighter(7600, 5900, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 11, this));
//        enemyShips.add(new EnemyFighter(7600, 6200, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 12, this));
//
//        enemyShips.add(new EnemyFighter(7600, 4700, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 13, this));
//        enemyShips.add(new EnemyFighter(7600, 4400, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 14, this));
//        enemyShips.add(new EnemyFighter(7600, 4100, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 15, this));
//        enemyShips.add(new EnemyFighter(7600, 3800, MainPackage.Type.Fighter, 3, 5, 5, .15, 200, 100, 16, this));
